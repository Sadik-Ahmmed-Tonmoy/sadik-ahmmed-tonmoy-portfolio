...
const HomeTitle = () => {
  return (
  <div id="home">
     <h5 className="border flex rounded-3xl py-2 px-5 w-min ms-4 md:ms-28 mb-5 md:mb-10">  <AiOutlineHome style={{fontSize: "1.44rem"}}/> <span className="ms-2">HOME</span></h5>
