    ...
    <div id="services" className="mt-14 md:my-24">
      ...
      <div className="md:w-9/12 mx-auto ">
        ...
        <div
          ...
          data-aos-duration="2000"
          className="hidden md:flex mt-5 md:mt-12 p-3 md:p-8 border rounded-xl relative m-2"
        >
          <div>
        ...
        <div
          ...
          data-aos-duration="2000"
          className="hidden md:flex mt-4 p-3 md:p-8 border rounded-xl relative m-2"
        >
          <div>
        ...
        {/* pc */}
        {/* mobile */}
        <div className="md:hidden mt-5 p-3 border rounded-xl relative m-2">
          <div>
            <h3 className="text-2xl mb-4">Full Stack Web Development</h3>
            <p className="md:w-8/12">
              With a strong foundation in the MERN stack (MongoDB, Express.js,
        ...
        <div className="md:hidden mt-4 p-3 border rounded-xl relative m-2">
          <div>
            <h3 className="text-2xl mb-4">Responsive Design</h3>
            <p className="md:w-8/12">
              As a MERN developer, I'm dedicated to creating web experiences
